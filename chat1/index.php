...
<head>
	...
	<script type="text/javascript">
		...
		// 		console.log(r[i].id_user, "id da msg")
		// 		if(r[i].id_user == id){
		// 			classe = "userInput";
		// 		} else { classe = "bot__output";}
		// 		$('.chatlist').prepend('<li class="' + classe + '"> <p class="author">' + r[i].nome + '</p>' + r[i].mensagem + ' <time>' + r[i].hora  + ':'+ r[i].minuto + '</time></li>');
        //     }
...
*/
		...
		var enviar = function(comment) {;
			...
			$.ajax({
				url: "http://localhost/Desirepedia/chat1/guard.php",
				method: "POST",
				data: {
					comentario: comment,
				},
